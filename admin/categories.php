	...
	if($category_result){
		...
		while($row = @mysql_fetch_array($category_result)){
			$category_output.= '<tr> 
									...
									<td style="width:200px"><a href="category-manager.php?category_id=' . $row['category_id'] . '">' . $row['category'] . '</a></td>
									<td>' . $row['description'] . '</td>
									<td>
										<a rel="Edit Category" href="ajax-category-edit.php?category_id=' . $row['category_id'] . '" class="modalopen"><img src="gfx/icon-edit.png" alt="edit" /></a>
...
<head>
	...
	<title>ReStyle | Category Manager</title>
		...
		<div class="full">
			<div class="box">
				...
				<div class="content">
					...
					<a href="category-manager.php" class="button green">Create A New Category</a>
					</form>
				</div>
	<!--**************************-->
