<?
	...
	if($_GET['manufacturer_id']){
		...
		$manufacturer_result = user_search($_GET['manufacturer_id'], '', 4);
	
		if($manufacturer_result){
			$row = @mysql_fetch_array($manufacturer_result);
...
<form id="manufacturer-edit" method="post">
		<input type="hidden" id="user_id" name="manufacturer_id" value="<?=$_GET['manufacturer_id']?>">						
