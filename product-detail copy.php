...
*/		
		...
		$source_result = source_search_by_product($_GET['id'], $state_location, 1);
		...
		if($source_result){
			...
			while($source_row = mysql_fetch_array($source_result)){
				...
				$source_style_output.= '<li>
											...
											<h3>' . $source_row['company'] . '</h3>
											<h4>' . $source_row['city'] . ', ' . $source_row['state'] . '</h4>
											<p>'. substr(strip_tags($source_row['description']),0,45) .'...</p>
											<a href="/ajax/ajax-product-email.php?product_id=' . $_GET['id'] . '&source_id=' . $source_row[0] . '" class="email">Email us</a>
										</li>';
				$i++;
			}
...
<br clear="all"><br />
		...
		<section id="get-the-look">
			<h2><span>Sources Who Carry this Product</span> <a href="<?=$change_location_link?>" class="change-location">Change location ></a></h2> 
			<ul>
				<?=$carry_output?>
			</ul>
		</section>
		...
		<?if($outside_output){?>
		<section id="get-the-look">
			<h2><span>Sources Outside Your Area</span> <a href="<?=$change_location_link?>" class="change-location">Change location ></a></h2>
			<ul>
				<?=$outside_output?>
			</ul>
		</section>
		...
		<?if($look_output){?>
		<section id="get-the-look">
			<h2><span>Sources Who Carry this Line</span> <a href="<?=$change_location_link?>" class="change-location">Change location ></a></h2>
		...
		<section id="get-the-look">
			<h2><span>Sources who can help with this style</span> <a href="<?=$change_location_link?>" class="change-location">Change location ></a></h2>
