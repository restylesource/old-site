...
<body class="home logged-in">
	...
	<div id="wrapper-page">
		...
		<section role="main">
		<div style="font-size: 1.3em; margin: 0.83em 0; text-align: center; text-transform: uppercase; line-height: 90%; font-family: "DIN", sans-serif;"><b>RE</b>STYLE<b>SOURCE</b> <span style="color:#acbc28">inspires + connects</span> you with design sources you love.</div> 
		<p style="font-size: 1.2em; margin: 0.83em 0; text-align: center;">We feature <strong>SHOPS</strong>, <strong>BUSINESSES</strong>, <strong>RESTAURANTS</strong> and <strong>STYLE SOURCES</strong> across the country where you can get <i>the look</i> and make it <i>your own</i>.</p></br>
			<div class="slideshow">
			...
			<div class="banner design-dilemmas">
				<a href="<?=$top_banner_url?>">
					<h2><?=$top_banner_title?></h2>
					<p><?=$top_banner_caption?> ></p>
				</a>
			...
			<div id="featured-grid">
				...
				<div class="featured what-is-restyle">
					<a href="ajax/ajax-what-is-restyle.html"><h3>What is <br />Restyle Source?</h3></a>
					<ul>
						<li><a href="#">Reclaim</a></li>
						<li><a href="#">Recreate</a></li>
						<li><a href="#">Restore</a></li>
						<li><a href="#">Redesign</a></li>
						<li><a href="#">Restyle</a></li>
				...
				<div class="featured banner">
					<a title="<?=$bottom_title?>" href="<?=$bottom_banner?>">
						<img src="<?=$bottom_banner_img?>" alt="<?=$bottom_alt?>" />
					</a>
				</div>
			</div> <!-- // #featured-grid -->
