<?
	...
	if($_POST){
		...
		if(unameAvailable(0, $_POST['email'])){
			...
			user_signup($_POST['email'], $_POST['password']);
...
<head>
	...
	<title><? include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/title.php'); ?> | Register</title>
...
<body class="registration logged-in">
	...
	<div id="wrapper-page">
		...
		<section role="main">
			...
			<span class="retailer-manufacturer-designer">Are you a <a href="registration-retailer.php">Retailer</a> / <a href="registration-manufacturer.php">Manufacturer + Showroom</a> / or <a href="registration-designer.php">Designer + Trade?</a></span>
				...
				<div class="column">
					...
					<div class="checkboxes small">
						<label for="agree">
							...
							<p>I agree to Restyle Source <a href="terms.php">Terms and Conditions</a></p>
						</label>
