...
function go_to_next_post(){
    ...
    jQuery(function(){
        if( jQuery('.project-controls').length ){
            jQuery('.project-controls a.next').each(function(){
...
function go_to_prev_post(){
    ...
    jQuery(function(){
        if( jQuery('.project-controls').length ){
            jQuery('.project-controls a.prev').each(function(){
                document.location.href= jQuery(this ).attr('href');
                return 0;
            });
        }else{
...
function open_next_post_comments(){
	...
	jQuery('#main .post').each(function(i, h3){ /* loop through article headings */
	  ...
	  if ( scrollTop < h2top ) { /* compare if document is below heading */
		...
		var permalink = (jQuery(h3).find('h3 a , h1 a').attr('href'));
...
function like(){
	scrollTop = jQuery(window).scrollTop();
    if(jQuery('#entry-meta-aside i.vote.love').length){

        jQuery('#entry-meta-aside i.vote.love').each(function(i, h2){ /* loop through article headings */
        ...
        jQuery('i.vote.love').each(function(i, h2){ /* loop through article headings */
...
function hate(){  
    scrollTop = jQuery(window).scrollTop();
    jQuery('i.vote.hate').each(function(i, h2){ /* loop through article headings */

        h2top = jQuery(h2).offset().top ; /* get article heading top */

        if (scrollTop < eval(h2top-19) || jQuery('#main .post .entry-meta').length ) { /* compare if document is below heading */
...
jQuery(document).ready(function(){
	...
	jQuery(document).keyup(function(e){
        ...
        var forbiddenKeys = new Array( 'j' , 'k' , 'v' , 'c' , 'l' , 'h', 's' , 'r' );
