...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri()?>/css/autoinclude/frontend.css">
      <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri()?>/css/autoinclude/globals.css">
      <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri()?>/css/autoinclude/ie.css">
      <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri()?>/css/autoinclude/small.css">
      <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri()?>/css/autoinclude/smart-grid.css">
      <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri()?>/css/autoinclude/style.css">
      <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri()?>/css/autoinclude/typography.css">
  </head>
<body>
