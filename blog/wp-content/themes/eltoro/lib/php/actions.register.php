<?php
    ...
    add_action( 'widgets_init', array( new FrontpageBuilder(), 'load_widget_elements' ) );
    ...
    add_action( 'wp_ajax_frontpage_builder_request' , array( 'FrontpageBuilder' , 'handle_request' ) );
