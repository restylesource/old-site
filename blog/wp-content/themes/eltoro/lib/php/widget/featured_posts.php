                ...
                if( is_user_logged_in () ){
                    ...
                    if( isset( $meta['safe'] ) ){
                        if( !meta::logic( $post , 'settings' , 'safe' ) ){
                            ...
                            $cnt_a1 = '  href="javascript:void(0)" onclick="get_login_box(\'nsfw\')"';
                            $cnt_a2 = '  href="javascript:void(0)" onclick="get_login_box(\'nsfw\')"';
							$cnt_a3 = ' class=" entry-img" href="javascript:void(0)" onclick="get_login_box(\'nsfw\')"';
                        }
                    }else{
                        $post_img = wp_get_attachment_image( get_post_thumbnail_id( $post -> ID ) , 'tsmall' , '' );
                        $cnt_a1 = ' href="' . get_permalink($post -> ID) . '"';
                ...
                <article class="entry-item"><!-- post title -->
					...
					<div class="entry-meta">
						<ul>
                            ...
                            <?php
                                if( options::logic( 'general' , 'enb_likes' ) ){
                                    like::content($post -> ID, 3, false, 'like');
                                }
                            ?>
						</ul>
					</div>
