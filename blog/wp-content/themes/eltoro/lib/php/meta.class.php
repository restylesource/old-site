                        ...
                        switch( substr($container , 0 , 12) ){
                            ...
                            case 'info-column-' : {
                                ...
                                foreach ( $field_ as $field ){
                                    ...
                                    if( $res == 'slideshow' && $field[ 'name' ] == 'type_res' && $field[ 'value' ] == 'text' ){
                                        $info_classes = 'text-slide-info-column';
                                    }
...
endhtml;
        ...
        function get_meta_records( $post_id = null , $args = null ){
            ...
            if( 'slideshow' == $res ){
                $result .= 'jQuery("div.sort-' . $res .'-'. $box . '").sortable({ handle: ".info-column h2", beforeStop : function(){';
            }else{
