		...
		<section role="main">
			...
			<form id="registration" method="post" onSubmit="return validateRegistration()">
				...
				<div class="column">
					...
					<input type="text" placeholder="Type of Designer" id="retail_type" name="retail_type" value="<?=$_POST['retail_type']?>" />
...
<ul>
	<li>Independent Brick and Mortar Retailer with a current operating storefront</li>
	<li>Must be a NON discounted retail store location</li>
</ul>	
</span>
