<?
	...
	$source_result = user_search($_GET['id'], '');
	...
	if($product_result){
		...
		while($row = mysql_fetch_array($product_result)){
			...
			if($user_group_id!=4 && $is_source<1){
...
?>	
		...
		<section id="get-the-look">
			...
			<?}?>
                        ...
                        <div class="fr">SHOW <a class="inline" href="/source-inventory.php?page1=1&id=<?=$_REQUEST['id']?>&limit=30">30</a> <a class="inline" href="/source-inventory.php?page1=1&id=<?=$_REQUEST['id']?>&limit=90">90</a> <a class="inline" href="/source-inventory.php?page1=1&id=<?=$_REQUEST['id']?>&limit=ALL">ALL RESULTS</a></div>
